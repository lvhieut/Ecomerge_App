...
class AdapterSausage(private var listSausage : MutableList<Order>, private var context: Context): RecyclerView.Adapter<AdapterSausage.MyViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return listSausage.size
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val listHamBurger = listSausage[position]
    ...
    inner class MyViewHolder(itemView : View) :RecyclerView.ViewHolder(itemView)  {
        val imgSausage: ImageView = itemView.findViewById(R.id.imgCategoriesFood)
