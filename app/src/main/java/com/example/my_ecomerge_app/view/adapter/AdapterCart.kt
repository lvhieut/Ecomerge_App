...
class AdapterCart(private var listCart : MutableList<Cart>, private var context: Context): RecyclerView.Adapter<AdapterCart.MyViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_order_cart, parent, false)
