...
class AdapterSalad(private var listSalad : MutableList<Order>, private var context: Context): RecyclerView.Adapter<AdapterSalad.MyViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return listSalad.size
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val listSalad = listSalad[position]
